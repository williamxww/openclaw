...
9. [Hook 事件系统](#9-hook-事件系统)
10. [多渠道接入层](#10-多渠道接入层)
11. [MCP 协议集成](#11-mcp-协议集成)
12. [ACP 协议支持](#12-acp-协议支持)
13. [沙箱执行环境](#13-沙箱执行环境)
14. [安全与审计体系](#14-安全与审计体系)
15. [插件化架构（Plugin SDK）](#15-插件化架构plugin-sdk)
16. [OpenAI 兼容 HTTP 网关](#16-openai-兼容-http-网关)
17. [轨迹追踪与可观测性](#17-轨迹追踪与可观测性)
18. [能力全景图](#18-能力全景图)
...
├─────────────────────────────────────────────────────────────────────┤
│                      编排层（Orchestration）                          │
│  子 Agent 系统 · Cron 调度 · Hook 事件 · 任务流注册表                 │
├─────────────────────────────────────────────────────────────────────┤
│                    Agent 运行时（Pi Runner）                          │
